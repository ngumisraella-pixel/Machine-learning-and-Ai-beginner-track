...
- ✅ [Start Here](./1-Month-ML-Internship/Chapter-1-Python-NLP-Architecture/Part-1/)

**Part 2: Text Preprocessing** (8 hours)
- Regular expressions for text cleaning
- Tokenization and normalization
- Stopword removal
- ✅ [Part 2](./1-Month-ML-Internship/Chapter-1-Python-NLP-Architecture/Part-2/)

**Part 3: File Indexing** (8 hours)
- Building inverted indexes
- Dynamic vocabulary
- Efficient lookups
- ✅ [Part 3](./1-Month-ML-Internship/Chapter-1-Python-NLP-Architecture/Part-3/)

**Part 4: Embeddings & Similarity** (9 hours)
- One-hot encoding
- Word embeddings
- Cosine similarity
- ✅ [Part 4](./1-Month-ML-Internship/Chapter-1-Python-NLP-Architecture/Part-4/)

**Part 5: NLP Integration** (8 hours)
- Full pipeline from text → similarity scores
- Capstone: Tiny NLP Engine
- ✅ [Part 5](./1-Month-ML-Internship/Chapter-1-Python-NLP-Architecture/Part-5/)
...
- Web scraping
- Error handling
- ✅ [Start Here](./1-Month-ML-Internship/Chapter-2-Data-Intensive-Search/Part-1/)

**Part 2: Feature Engineering** (9 hours)
- Encoding categorical variables
- Scaling (normalization, standardization)
- Feature creation
- ✅ [Part 2](./1-Month-ML-Internship/Chapter-2-Data-Intensive-Search/Part-2/)

**Part 3: Data Visualization** (8 hours)
- Matplotlib and Seaborn
- EDA techniques
- Interactive visualizations
- ✅ [Part 3](./1-Month-ML-Internship/Chapter-2-Data-Intensive-Search/Part-3/)

**Part 4: Information Retrieval** (9 hours)
- Boolean retrieval
- Ranking functions (TF-IDF)
- Inverted index implementation
- ✅ [Part 4](./1-Month-ML-Internship/Chapter-2-Data-Intensive-Search/Part-4/)

**Part 5: Search Interface** (8 hours)
- Streamlit web framework
- Building interactive search
- Capstone: Micro Search Engine
- ✅ [Part 5](./1-Month-ML-Internship/Chapter-2-Data-Intensive-Search/Part-5/)
...
- ✅ [Start Here](./1-Month-ML-Internship/Chapter-3-ML-Algorithms/Part-1/)
...
- ✅ [Part 2](./1-Month-ML-Internship/Chapter-3-ML-Algorithms/Part-2/)
...
- ✅ [Part 3](./1-Month-ML-Internship/Chapter-3-ML-Algorithms/Part-3/)
...
- ✅ [Part 4](./1-Month-ML-Internship/Chapter-3-ML-Algorithms/Part-4/)
...
- ✅ [Part 5](./1-Month-ML-Internship/Chapter-3-ML-Algorithms/Part-5/)
...
1. Open [Chapter-1-Python-NLP-Architecture/Part-1](./1-Month-ML-Internship/Chapter-1-Python-NLP-Architecture/Part-1/)
